...
Using test driven development, this app utilizes Javascript along with NodeJS and npm Inquirer, this application prompts the user in the command line to gather information. This information is then used to generate a team profile page using HTML, CSS, and Bootstrap.
